...
mod tests {
    ...
    fn test_parse_stype32_sb() {
        let result = parse_stype32(&0b0100011, &0b000000000001, &0b000, &0b00010, &0b00011).unwrap();
    ...
    fn test_parse_stype32_sh() {
        let result = parse_stype32(&0b0100011, &0b000000000001, &0b001, &0b00010, &0b00011).unwrap();
    ...
    fn test_parse_stype32_sw() {
        let result = parse_stype32(&0b0100011, &0b000000000001, &0b010, &0b00010, &0b00011).unwrap();
    ...
    fn test_parse_stype32_invalid_funct3() {
        let result = parse_stype32(&0b0100011, &0b000000000001, &0b011, &0b00010, &0b00011);
